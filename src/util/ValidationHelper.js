export class ValidationHelper {
  static mailNotVailid(inputValue) {
    const emailRegex =
  ...
  static houseNumberNotValid(str) {
    var code, i, len;
  ...
  static alphanunericInputNotValid(inputValue) {
    if (this.isAlphaNumeric(inputValue) && inputValue.length > 0) return false;
    else return true;
  }

  static postCodeNotValid(str) {
    var code, i, len;
    if (str === undefined) return true;
  ...
  static phoneNumberNotValid(str) {
    var code, i, len;
